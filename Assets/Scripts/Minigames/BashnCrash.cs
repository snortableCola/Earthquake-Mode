...
public class BashnCrash : Minigame
{
    ...
    public override string Instructions { get; } = $"Smash your competition's HQ to the ground!! Mash your <sprite name=\"XboxA\">/<sprite name=\"PSCross\"> button on your controller or click on the bash button like your career depends on it. Each mash deals damage to the HQ. The first to destroy the enemy HQ wins 5 corruption coins!";
