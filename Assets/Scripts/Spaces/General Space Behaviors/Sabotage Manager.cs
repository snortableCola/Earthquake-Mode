...
public class SabotageManager : MonoBehaviour
{
	...
	public IEnumerator Sabotage(Player saboteur)
	{
		...
		PanelManager.Instance.ShowPanel(_victimSelectPanel, PanelManager.Instance._victimSelectButton);
		...
		PanelManager.Instance.ShowPanel(_methodSelectPanel, PanelManager.Instance._methodSelectButton);
